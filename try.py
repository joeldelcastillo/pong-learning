...
# Reference https://medium.com/@dhruvp/how-to-write-a-neural-network-to-play-pong-from-scratch-956b57d4f6e0
# Everything here is copied haha, but it works.
# It is just a sample
...
def main():
    env = gym.make("ALE/Pong-v5", render_mode="human")
    observation, info = env.reset(seed=42)  # This gets us the image
    ...
    while True:
        ...
        observation, reward, done, info, hola = env.step(action)
